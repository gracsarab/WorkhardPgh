var drugs=[
{name:"Buprenorphine (Subutex, Suboxone,<br/> Zubsolv, Temgesic, Buprenex,<br/> Norspan, Butrans)",screeningTest:"Opiates Immunoassay",screeningExpected:"Opiates - Negative",screeningUnexpected:"Opiates - Positive",confirmatoryTest:"GC/MS or LC/MS Buprenorphine",confirmatoryExpected:"Buprenorphine / Nor<br/>buprenorphine",confirmatoryUnexpected:"Buprenorphine / Nor<br/>buprenorphine - None Detected",falsePositives:"Tramadol; other opioids including (Codeine, Heroin, Morphine)",detectionRange:"1 to 10 days after use",category:"Synthetic Opioid"},
